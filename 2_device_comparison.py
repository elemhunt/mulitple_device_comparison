...
# Run 1
correction_val1_s1 = 1962.55834104502
correction_val1_s2 = 1847.60876033524

# Run 2
correction_val2_s1 = 2911.19439064994
correction_val2_s2 = 3846.00129528978

# Run 3
correction_val3_s1 = 3253.74951578507
correction_val3_s2 = 4581.59870143258

# Run 4
correction_val4_s1 = 3318.33650962201
correction_val4_s2 = 4741.82445302804
...
# Run 1
CV_r1_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CV_0.005Vs_2C.txt')
CV_r1_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CV_0.005Vs_2C.txt')

CD_r1_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CD_20e-6A_3C.txt')
CD_r1_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CD_20e-6A_3C.txt')

# Run 2
CV_r2_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CV_0.01Vs_2C.txt')
CV_r2_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CV_0.01Vs_2C.txt')

CD_r2_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CD_50e-6A_3C.txt')
CD_r2_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CD_50e-6A_3C.txt')

# # Run 3
CV_r3_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CV_0.02Vs_2C.txt')
CV_r3_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CV_0.02Vs_2C.txt')

CD_r3_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CD_100e-6A_3C.txt')
CD_r3_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CD_100e-6A_3C.txt')

# # Run 4
CV_r4_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CV_0.05Vs_2C.txt')
CV_r4_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CV_0.05Vs_2C.txt')

CD_r4_s1 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S032/_CD_200e-6A_3C.txt')
CD_r4_s2 = np.genfromtxt('/Users/elemhunt/Google Drive/Thesis Elijah /Thesis -- Drafts and Cited Referenes /DATA/Data/Laser Induced Graphene/LIG Microsupercaps/Gels/S033/_CD_200e-6A_3C.txt')
...
ax1.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
ax2.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
ax3.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
ax4.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs[0, 0].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})


axs[0, 1].plot(voltage_r2_s1,current_r2_s1,'g', linewidth=2.0)
axs[0, 1].plot(voltage_r2_s2,current_r2_s2,'b', linewidth=2.0)
axs[0, 1].set_title('(b)')
axs[0, 1].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs[1, 0].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs[1, 1].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
fig.savefig('CV S032 S033 wired .png', dpi = 1000)
...
bx1.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
bx2.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
bx3.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
bx4.legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs2[0, 0].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs2[0, 1].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs2[1, 0].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
axs2[1, 1].legend(['Non-Wired','Wired'],loc='upper left', prop={'size': 7})
...
fig.savefig('CD S032 S033 wired.png', dpi = 1000)
